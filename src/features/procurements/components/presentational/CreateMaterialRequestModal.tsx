...
/**
 * CreateMaterialRequestModal component for creating a new material request.
 *
 * Features:
 ...
 * @returns The rendered create material request modal
 */
export const CreateMaterialRequestModal = ({
    ...
    const updateItem = <K extends keyof MaterialRequestItemInput>(
        index: number,
        field: K,
        value: MaterialRequestItemInput[K]
    ) => {
        ...
        const payloadItems = items.map(item => {
            ...
            return {
                ...
                ...(item.reason === 'other' && item.reasonOther?.trim() && {
                    reasonOther: item.reasonOther.trim()
                }),
            };
        });
        ...
        <Dialog open={open} onOpenChange={(o) => !o && handleClose()}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Add items needed for project #{projectId}
                    </DialogDescription>
                </DialogHeader>
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        value={item.reason}
                                        onChange={(e) => {
                                            const newReason = e.target.value as MaterialRequestItemInput['reason'];
                                            updateItem(index, 'reason', newReason);
                                            if (newReason !== 'other') {
                                                updateItem(index, 'reasonOther', '');
                                            }
                                        }}
                                    >
