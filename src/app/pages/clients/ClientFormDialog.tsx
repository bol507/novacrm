...
const ClientFormDialog = ({ open, onOpenChange, onSubmit }: ClientFormDialogProps) => {
    const form = useForm<ClientFormValues>({
        resolver: zodResolver(clientFormSchema),
        defaultValues: {
            accountname: "",
            account_no: undefined, // 👈 Opcional, puede ser undefined
